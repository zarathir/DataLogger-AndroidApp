 ...
 */
public class UnitArduino extends LoggingUnit implements IntfWifi, Serializable  {
    private static final long serialVersionID = 1L;

    private InetAddress ipAdress;   //just used with the Connectiontyp "WIFI"
    private EnumConnection connectionTyp;


    //constructor
    public UnitArduino(String unitName, InetAddress ipAdress, EnumConnection connectionTyp) {
        super(unitName);
