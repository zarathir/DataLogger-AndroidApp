...
/**
 * This Class is testing the Class UnitRaspberry.
 * @author M.Gasser
 * @version 1.000  18.06.2021
 */
public class UnitRaspberryTest {
    private static boolean firstSetup = true;

    private UnitRaspberry unit1;
    private UnitRaspberry unit2;
    ...
    public  void setUp() throws Exception {
        if (firstSetup) {
            PrintOnMonitor.printlnMon("*** Setup Unittest for UnitRaspberry ***", PrintOnMonitor.Reason.UNITTEST);
            firstSetup = false;
        }

        InetAddress ipAdress = Inet4Address.getByName("192.168.0.15");
        unit1 = new UnitRaspberry("TestUnit1", ipAdress, EnumConnection.WIFI);
        ipAdress = Inet4Address.getByName("192.168.1.16");
        unit2 = new UnitRaspberry("TestUnit2", ipAdress, EnumConnection.WIFI);
    }
